           ...
           //25.up arrow using Robot
			...
			//28.send value to the alert
				...
				public static void allOptions(WebElement ele) {
					...
					//43(1).getoptions
					public static List<WebElement> getoptions1(WebElement ele) {
				...
				//66.WebDriverWait - visibility of Element Located 
				public static void eleSelectedVisiblityWebDriverWait(int seconds,String path) {
					W = new WebDriverWait(driver,seconds);
					W.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(path)));
				}
				...
				public static String getData (String sheetname,int rownumber, int cellnumber) throws IOException  {
					...
					File f = new File("D:\\My WorkSpace\\SchoolOptimaAutomation\\target\\InputData\\Sakthixl2 (1).xlsx");
					...
					Row row2 = s.getRow(rownumber);
						...
						String value =" ";
					Cell cell = (Cell) row2.getCell(cellnumber);
				...
				//77.uploadFileWithRobot
				 ...
				 public static void uploadFileWithRobot (String imagePath) {
		            ...
		            //78.Launch the Application in Different Browser
				 
				 
				 public static void LaunchdifferentApplication(String browser ) {
